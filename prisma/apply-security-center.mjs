// One-off migration apply script — Phase 13 Security Center
// Usage: $env:DATABASE_URL="mysql://..."; node prisma/apply-security-center.mjs
...
const sql       = readFileSync(
  join(__dirname, "migrations/20260610090000_security_center/migration.sql"),
  "utf8"
);
...
await conn.end();
console.log("\nDone. Run: npx prisma migrate resolve --applied 20260610090000_security_center");
