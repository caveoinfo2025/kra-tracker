...
const ROLE_GRANTS: Grant[] = [
  ...
  ["Business Head", MODULE.FINANCE,  "Conveyance",         [ACTION.VIEW, ACTION.APPROVE]],
  ...
  // Step 2W — dedicated Finance permission resources (Step 2S catalogue, Step 2U/2V seeded+visible)
  ["Finance Manager", MODULE.FINANCE,  "Voucher",    [ACTION.VIEW, ACTION.CREATE, ACTION.EDIT, ACTION.DELETE, ACTION.APPROVE, ACTION.EXPORT]],
  ["Finance Manager", MODULE.FINANCE,  "BankBook",   [ACTION.VIEW, ACTION.CREATE, ACTION.EDIT, ACTION.APPROVE, ACTION.IMPORT, ACTION.EXPORT]],
  ["Finance Manager", MODULE.FINANCE,  "CashBook",   [ACTION.VIEW, ACTION.CREATE, ACTION.EDIT, ACTION.APPROVE, ACTION.EXPORT]],
  ["Finance Manager", MODULE.FINANCE,  "Conveyance", [ACTION.VIEW, ACTION.CREATE, ACTION.EDIT, ACTION.APPROVE, ACTION.EXPORT]],
