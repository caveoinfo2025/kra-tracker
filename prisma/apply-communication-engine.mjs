// One-off migration apply script — Phase 11 Communication Engine
// Usage: $env:DATABASE_URL="mysql://..."; node prisma/apply-communication-engine.mjs
...
const sql       = readFileSync(
  join(__dirname, "migrations/20260609070000_communication_engine/migration.sql"),
  "utf8"
);
...
await conn.end();
console.log("\nDone. Run: npx prisma migrate resolve --applied 20260609070000_communication_engine");
