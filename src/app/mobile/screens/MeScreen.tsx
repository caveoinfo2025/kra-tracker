...
export default function MeScreen({ userName, userEmail, isManager, employeeId, onKRAs, onTeam, onTasks, onCollections, onOpportunities, onExpense, onConveyance }: Props) {
  const menuItems = [
  ...
  const financeItems = [
    { icon: "receipt", label: "Expense Claim",  sub: "Capture a bill & claim",        action: onExpense },
    { icon: "car",     label: "Local Conveyance", sub: "Log a trip by distance",      action: onConveyance },
  ];
  ...
  return (
    <div className="m-screen">
      <div className="m-content has-tabbar">
        ...
        {/* Finance section */}
        <div className="m-section">
          <div className="m-section-label">Finance</div>
          <div className="m-list">
