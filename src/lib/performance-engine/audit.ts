...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  performance_review_reopened: "Performance Review Reopened",
  performance_review_self_submitted: "Self-Review Submitted",
  performance_review_manager_submitted: "Manager Review Submitted",
  performance_review_finalized: "Performance Review Finalized",
  CREATE: "Created",
  UPDATE: "Updated",
  DELETE: "Deleted",
};
